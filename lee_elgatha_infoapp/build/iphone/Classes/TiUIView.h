...
/**
 Base class for all information views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the information view hierarchy (such as wrapped iOS UIViews) was touched.
