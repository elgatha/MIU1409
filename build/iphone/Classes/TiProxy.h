...
//Rare exceptions to indicate a bug in the _lee_elgatha_aboutme code (Eg, function that a subclass should have implemented)
...
/**
 The base class for Lee_Elgatha_AboutMe proxies.
 */
