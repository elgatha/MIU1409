...
/**
 The base class for all Lee_Elgatha_AboutMe modules
 */
...
/**
 Lee_Elgatha_AboutMe Platform calls this method on startup.
 */
-(void)startup;

/**
 Lee_Elgatha_AboutMe Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 Lee_Elgatha_AboutMe Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 Lee_Elgatha_AboutMe Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 Lee_Elgatha_AboutMe Platform calls this method on resume.
 @param sender The sender of the event.
 */
