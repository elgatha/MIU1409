...
@interface Lee_Elgatha_AboutMeObject : KrollCoverageObject {
#else
@interface Lee_Elgatha_AboutMeObject : KrollObject {
#endif
@private
...
extern NSString * Lee_Elgatha_AboutMe$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Lee_Elgatha_AboutMeObject *_lee_elgatha_aboutme;
    KrollObject* console;
	BOOL shutdown;
