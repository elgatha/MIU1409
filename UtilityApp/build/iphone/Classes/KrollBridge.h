...
@interface UtilityAppObject : KrollCoverageObject {
#else
@interface UtilityAppObject : KrollObject {
#endif
@private
...
extern NSString * UtilityApp$ModuleRequireFormat;
