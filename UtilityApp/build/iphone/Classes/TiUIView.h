...
/**
 Base class for all UtilityApp views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the UtilityApp view hierarchy (such as wrapped iOS UIViews) was touched.
