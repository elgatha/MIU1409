...
/**
 Base class for all Lee_Elgatha_AboutMe views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the Lee_Elgatha_AboutMe view hierarchy (such as wrapped iOS UIViews) was touched.
