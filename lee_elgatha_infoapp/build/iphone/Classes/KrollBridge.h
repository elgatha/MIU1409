...
@interface informationObject : KrollCoverageObject {
#else
@interface informationObject : KrollObject {
#endif
@private
...
extern NSString * information$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	informationObject *_information;
    KrollObject* console;
	BOOL shutdown;
