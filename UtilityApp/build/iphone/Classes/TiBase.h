...
// in simulator we redefine to format for UtilityApp Developer console
...
{\
	NSString * exceptionName = [@"org.utilityapp." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.utilityapp";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIUtilityAppNativeItemNone = -1, 
	UIUtilityAppNativeItemSpinner = -2,
	UIUtilityAppNativeItemProgressBar = -3,
	
	UIUtilityAppNativeItemSlider = -4,
	UIUtilityAppNativeItemSwitch = -5,
	UIUtilityAppNativeItemMultiButton = -6,
	UIUtilityAppNativeItemSegmented = -7,
	
	UIUtilityAppNativeItemTextView = -8,
	UIUtilityAppNativeItemTextField = -9,
	UIUtilityAppNativeItemSearchBar = -10,
	
	UIUtilityAppNativeItemPicker = -11,
	UIUtilityAppNativeItemDatePicker = -12,
	
	UIUtilityAppNativeItemInfoLight = -13,
	UIUtilityAppNativeItemInfoDark = -14,
	
	UIUtilityAppNativeItemDisclosure = -15,
	
	UIUtilityAppNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all UtilityApp instances of
