...
//@interface lee_elgatha_aboutmeObject : NSObject
//@end

@interface lee_elgatha_aboutmeObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[lee_elgatha_aboutmeObject class]])
		{
			for (NSString *key in [[(lee_elgatha_aboutmeObject*)o modules] allKeys])
			{
