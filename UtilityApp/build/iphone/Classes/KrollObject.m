...
//@interface UtilityAppObject : NSObject
//@end

@interface UtilityAppObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[UtilityAppObject class]])
		{
			for (NSString *key in [[(UtilityAppObject*)o modules] allKeys])
			{
