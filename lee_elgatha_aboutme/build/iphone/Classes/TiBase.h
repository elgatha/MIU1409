...
// in simulator we redefine to format for lee_elgatha_aboutme Developer console
...
{\
	NSString * exceptionName = [@"org.lee_elgatha_aboutme." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.lee_elgatha_aboutme";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIlee_elgatha_aboutmeNativeItemNone = -1, 
	UIlee_elgatha_aboutmeNativeItemSpinner = -2,
	UIlee_elgatha_aboutmeNativeItemProgressBar = -3,
	
	UIlee_elgatha_aboutmeNativeItemSlider = -4,
	UIlee_elgatha_aboutmeNativeItemSwitch = -5,
	UIlee_elgatha_aboutmeNativeItemMultiButton = -6,
	UIlee_elgatha_aboutmeNativeItemSegmented = -7,
	
	UIlee_elgatha_aboutmeNativeItemTextView = -8,
	UIlee_elgatha_aboutmeNativeItemTextField = -9,
	UIlee_elgatha_aboutmeNativeItemSearchBar = -10,
	
	UIlee_elgatha_aboutmeNativeItemPicker = -11,
	UIlee_elgatha_aboutmeNativeItemDatePicker = -12,
	
	UIlee_elgatha_aboutmeNativeItemInfoLight = -13,
	UIlee_elgatha_aboutmeNativeItemInfoDark = -14,
	
	UIlee_elgatha_aboutmeNativeItemDisclosure = -15,
	
	UIlee_elgatha_aboutmeNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all lee_elgatha_aboutme instances of
